...
public class ConsensusMessage extends SystemMessage {
    ...
    /**
     * Creates a consensus message. Used by the message factory to create a COLLECT or PROPOSE
     * message TODO: How about removing the modifier, to make it visible just within the package?
     *
     ...
     * @param value This should be null if its a COLLECT message, or the proposed value if it is a
     *     PROPOSE message
     */
    ...
    /**
     * Creates a consensus message. Used by the message factory to create a FREEZE message TODO: How
     * about removing the modifier, to make it visible just within the package?
     *
    ...
    public String getPaxosVerboseType() {
        if (paxosType == MessageFactory.PROPOSE) return "PROPOSE";
        else if (paxosType == MessageFactory.ACCEPT) return "ACCEPT";
        else if (paxosType == MessageFactory.WRITE) return "WRITE";
        // START DECISION-FORWARDING
        else if (paxosType == MessageFactory.REQ_DECISION) return "REQ_DECISION";
        else if (paxosType == MessageFactory.FWD_DECISION) return "FWD_DECISION";

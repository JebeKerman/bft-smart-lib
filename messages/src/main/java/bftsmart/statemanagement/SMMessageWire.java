 ...
 * @author Joao Sousa
 */
public abstract class SMMessageWire extends SystemMessage {

    private Serializable state; // State log
    private View view;
     ...
     */
    protected SMMessageWire(int sender, int cid, int type, Serializable state, View view, int regency, int leader, boolean triggerSMLocally) {
        super(sender);
        this.state = state;
        this.view = view;
        this.cid = cid;
